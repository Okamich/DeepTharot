...
class Game {
    constructor() {
        ...
        this.levels = {
            ...
            3: [
                { name: "Горный перевал", minEnemies: 3, maxEnemies: 4, enemyLevel: 3 },
                { name: "Орочья крепость", minEnemies: 3, maxEnemies: 5, enemyLevel: 4 },
                { name: "Тронный зал", minEnemies: 4, maxEnemies: 5, enemyLevel: 5 }
            ]
        };
    ...
    explorationStep() {
        ...
        this.explorationProgress += 5 + Math.floor(Math.random() * 10);
